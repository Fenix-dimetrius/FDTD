...
#include "../../SVCH_AutoEmis/bodycls.h"
...
QT_MOC_LITERAL(3, 16, 7), // "double*"
QT_MOC_LITERAL(4, 24, 1), // "x"
QT_MOC_LITERAL(5, 26, 1), // "y"
QT_MOC_LITERAL(6, 28, 4), // "size"
QT_MOC_LITERAL(7, 33, 8), // "finished"
QT_MOC_LITERAL(8, 42, 5), // "error"
QT_MOC_LITERAL(9, 48, 3), // "err"
QT_MOC_LITERAL(10, 52, 7) // "process"

    },
    "BodyCls\0rePlot\0\0double*\0x\0y\0size\0"
    "finished\0error\0err\0process"
};
...
void BodyCls::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->rePlot((*reinterpret_cast< double*(*)>(_a[1])),(*reinterpret_cast< double*(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            typedef void (BodyCls::*_t)(double * , double * , int );
...
// SIGNAL 0
void BodyCls::rePlot(double * _t1, double * _t2, int _t3)
{
